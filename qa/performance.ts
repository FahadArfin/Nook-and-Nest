...
function reset(){generation++;fixture=performanceScene(select.value as PerformanceSceneId);renderer.update(fixture.plan,'perf-floor');renderer.showHomeShot(fixture.shot,true);status.textContent='Ready. Wait for model loading to settle. Orbit manually during the capture to exercise rendering.';}
