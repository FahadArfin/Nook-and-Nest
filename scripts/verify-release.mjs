...
assert(raw.length < 700_000, 'Welcome entry exceeded the Beta 2 700 kB budget');
assert(compressed.length < 220_000, 'Welcome entry gzip exceeded the Beta 2 220 kB budget');
