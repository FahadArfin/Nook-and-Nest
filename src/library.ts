...
const families: Record<string, string[]> = {
  ...
  "Chairs & stools": ["breakfast-nook-chair","solarium-rocker","breakfast-chair","armchair","ottoman","dining-chair","bar-stool","office-chair","ergonomic-office-chair","gaming-chair","bench"],
  ...
  "Tables": ["breakfast-nook-table","breakfast-table","dining-table","round-table"],
  ...
  "Rugs": ["bath-ribbed-rug","low-pile-carpet","diamond-wool-rug","kilim-rug","jute-rug","arch-color-rug","wide-check-rug","round-rug","runner-rug","braided-rug","scallop-rug","checker-rug"],
