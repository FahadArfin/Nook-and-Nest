...
export const studioMountHeight=(id:string):number|undefined=>id==='apartment-bedside-floating-cubby'?400:id==='toilet-neorest-wall'?150:id.startsWith('recessed-')?2450:id==='ceiling-opal-flush'?2400:id.startsWith('shelf-floating-')?1400:id==='unifi-g6-bullet'||id==='unifi-g6-instant'?2100:id.includes('doorbell')?1200:undefined;
