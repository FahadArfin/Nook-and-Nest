...
export interface FurniturePlacement {terrainAnchored?:boolean; showerMirrored?:boolean; moduleRun?:boolean; id: string; catalogId: string; floorId: string; x: number; z: number; rotation: number; widthMm: number; depthMm: number; heightMm: number; variant: string; toFloorId?: string; stairRiseMm?: number; surfaceVariant?: string; materialColors?: Record<string,string>; openFraction?:number; doorless?:boolean; elevationMm?: number }
