...
export interface PlanDocumentV1 {
  ...
  environment?: { background: "plain"|"city"|"suburban"|"rural"|"farm"|"medieval"; grass:"off"|"sparse"|"lush"; sun?:import('./sunlight').SunSettings; backdropRotation?:number; citySource?:'standard'|'google'; cityHeight?:number; terrain?:import('./terrain').TerrainStroke[] };
