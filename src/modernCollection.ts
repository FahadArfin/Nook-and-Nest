...
// Only new placements use these defaults; saved variants and part colors stay authoritative.
export const modernDefaultVariant=(id:string)=>(furnitureDefaults as Record<string,string>)[id]??'white';
