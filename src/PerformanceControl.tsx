import {QuickPinSettings} from './EditorExperience';
...
export function PerformanceControl({controller}:{controller?:SceneController}){
 ...
 <label className="ghost-setting"><span>Ghost floor below</span><input type="checkbox" role="switch" checked={s.plan.camera.ghostBelow} onChange={()=>s.toggleCameraSetting('ghostBelow')}/></label><QuickPinSettings/></ToolPopover></>;
}
