...
export const defaultMountHeight = (id:string):number|undefined => kitchenMountHeight(id)??(windowTreatmentIds.has(id)?(id.startsWith("curtain")?80:650):cozyMount(id)==="ceiling"?1500:id==="floating-nightstand"?350:isDoor(id)?0:id==="wall-hung-sink"?650:id==="floating-bath-vanity"?350:id==="wall-hung-toilet"?150:isWindow(id)?850:isWallMounted(id)?1100:undefined);
