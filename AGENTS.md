...
Connected-room drafting (September 25): provide a separate wall-line sketch tool that detects each bounded room across crossing lines and T-junctions. Preview before applying, preserve concave shapes and existing room data, discard open tails, and apply all rooms as one undoable change. Offer conversion of an unfinished Custom room sketch. Imported wall-first plans retain their existing Generate regions and footprint lock.
