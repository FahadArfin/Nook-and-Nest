...
Production builds extract identical embedded GLB images into 12 shared, content-hashed textures. Geometry, nodes, materials and original image bytes remain unchanged; editable sources and standalone public GLBs retain their embedded images. This saves about 67 MB and keeps the expanded deployment under the Sites size limit. A whole-catalog asset test verifies byte-preserving extraction and relative texture paths.
